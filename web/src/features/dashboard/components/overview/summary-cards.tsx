        ...
        <div className='flex flex-col justify-between gap-3 border-t bg-[linear-gradient(135deg,color-mix(in_oklch,var(--overview-accent-2)_12%,var(--background))_0%,color-mix(in_oklch,oklch(0.82_0.04_155)_8%,var(--background))_48%,color-mix(in_oklch,var(--overview-accent-1)_7%,var(--background))_100%)] p-3 sm:gap-4 sm:p-5 xl:border-t-0 xl:border-l'>
          <div className='flex flex-1 flex-col gap-2 sm:gap-3'>
            ...
            <div className='my-auto grid grid-cols-2 gap-2 sm:gap-3'>
              <div className='bg-background/60 flex min-h-20 flex-col justify-center rounded-xl px-3 py-3 sm:min-h-24 sm:px-4 sm:py-4'>
                <div className='text-muted-foreground flex items-center gap-1 text-[11px] leading-none font-medium'>
                  <Flame className='size-3 shrink-0' aria-hidden='true' />
                  <span className='truncate'>{t('Today usage')}</span>
                </div>
                <div className='text-foreground mt-2 truncate font-mono text-base font-bold tabular-nums sm:text-lg'>
              ...
              <div className='bg-background/60 flex min-h-20 flex-col justify-center rounded-xl px-3 py-3 sm:min-h-24 sm:px-4 sm:py-4'>
                ...
                <div
                  className={cn(
                    'mt-2 truncate font-mono text-base font-bold tabular-nums sm:text-lg',
